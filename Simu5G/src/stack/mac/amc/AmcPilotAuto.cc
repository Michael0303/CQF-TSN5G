...
const UserTxParams& AmcPilotAuto::computeTxParams(MacNodeId id, const Direction dir, double carrierFrequency) {
    ...
    // DEBUG
    // EV << NOW << "AmcPilotAuto::computeTxParams txMode: " << txMode << endl;
    // EV << NOW << "AmcPilotAuto::computeTxParams Rank(ri): " << sfb.getRi() << endl;
    // EV << NOW << "AmcPilotAuto::computeTxParams chosenCqi: " << chosenCqi << " chosenBand(pmi): " << chosenBand << endl;
    // EV << NOW << "AmcPilotAuto::computeTxParams bandSet: ";
    // for (auto i : bandSet)
    //     EV << i << " ";
    // EV << endl;
    // EV << NOW << " AmcPilotAuto::computeTxParams antenna set: ";
    // for (auto i : antennas)
    //     EV << i << " ";
    // EV << endl;
